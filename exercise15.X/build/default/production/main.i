...
# 15 "C:\\Program Files\\Microchip\\xc8\\v2.30\\pic\\include\\c99\\math.h" 3
# 1 "C:\\Program Files\\Microchip\\xc8\\v2.30\\pic\\include\\c99\\bits/alltypes.h" 1 3
...
void main(void)
{
    ...
    while (1)
    {
       ...
       UART2_Write(0x5F);
       UART2_Write(convertedValue & 0x00FF);
       UART2_Write(convertedValue >> 8);
       UART2_Write(0xA0);
...
unsigned int convertADCtoMillivolts(unsigned int adcValue)
{
    return ((unsigned int)((adcValue + 0.5)*(3856 - 1286)/4096 + 1286));
}
