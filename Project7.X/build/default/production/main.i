...
void main(void)
{
    ...
    while (1)
    {
        ...
        has_switch_changed = poll_switch1_for_edges(PORTDbits.RD1);
        ...
        switch(status)
        {
            case 1: do { LATDbits.LATD3 = 1; } while(0);
                                            do { LATDbits.LATD2 = 0; } while(0);
                                            PWM5_LoadDutyValue(0);
                                            break;
            case 2: do { LATDbits.LATD3 = 0; } while(0);
                                            do { LATDbits.LATD2 = 1; } while(0);
                                            PR2=30;
                                            PWM5_LoadDutyValue(35);
                                            break;
            case 3: do { LATDbits.LATD3 = 0; } while(0);
                                            do { LATDbits.LATD2 = 1; } while(0);
                                            PR2=30;
                                            PWM5_LoadDutyValue(25);
                                            break;
            case 4: do { LATDbits.LATD3 = 0; } while(0);
                                            do { LATDbits.LATD2 = 1; } while(0);
                                            PR2=20;
                                            PWM5_LoadDutyValue(18);
                                            break;
            case 5: do { LATDbits.LATD3 = 0; } while(0);
                                            do { LATDbits.LATD2 = 1; } while(0);
                                            PR2=30;
