...
# 54 "mcc_generated_files\\uart2.h" 2
...
{
 unsigned int i;
 while ((UART2_is_rx_ready()) == 1)
 ;
 while( UART2_Read() != 13 ) for(i=0; i<10000ul; i++);

}
# 27 "../exercise16.X/myUART.c"
void ReadNUART2(char holds_string[], unsigned int length_N)
{
 ...
 do {
     ...
     letter = UART2_Read();
            ...
            if( 127 == letter )
              ...
              {
        holds_string[i] = letter;
        i++;
               }

     } while ( (letter != 13) && (i <= length_N) );
