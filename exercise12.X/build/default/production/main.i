...
# 104 "C:\Program Files\Microchip\xc8\v2.30\pic\include\c90\stdlib.h"
...
# 4 "C:\Program Files\Microchip\xc8\v2.30\pic\include\c90\ctype.h"
...
T_on = ((m+1.0)*65536.0 - (float)timer0ReloadVal16bit)*pow(2.0,n)*4.0/ 8000000;
T_off = ((m+1.0)*65536.0 - 19786.0)*pow(2.0,n)*4.0/ 8000000;
f = 1/(T_on + T_off);
