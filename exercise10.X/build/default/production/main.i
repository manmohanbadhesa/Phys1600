...
# 35 "mcc_generated_files/rtcounter.h"
...
switch(counter)
{
case 1: do { LATDbits.LATD2 = 1; } while(0);
do { LATDbits.LATD1 = 0; } while(0);
break;
case 2: do { LATDbits.LATD1 = 1; } while(0);
do { LATDbits.LATD2 = 0; } while(0);
break;
case 3: do { LATDbits.LATD2 = 0; } while(0);
do { LATDbits.LATD1 = 0; } while(0);
break;
}
}
