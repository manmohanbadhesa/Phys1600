...
# 1 "mcc_generated_files/rtcounter.c"
...
# 49 "mcc_generated_files/rtcounter.c"
static uint32_t g_rtcounterH = 0;

static rtcountStruct_t * volatile rtcoutListHead = (0);
...
while(thisone)
{
thisone->absoluteTime &= 0x7FFFFFFF;
