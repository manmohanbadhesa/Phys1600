...
# 1 "mcc_generated_files/drivers/timeout.c"
...
# 51 "mcc_generated_files/drivers/timeout.h"
...
# 100 "mcc_generated_files/drivers/../tmr0.h"
...
# 37 "mcc_generated_files/drivers/timeout.c"
...
timerStruct_t *listHead = (0);
timerStruct_t * volatile executeQueueHead = (0);
...
inline void setTimerDuration(uint32_t duration)
{
lastTimerLoad = TMR0H - duration;

TMR0_WriteTimer(0);

PIR3bits.TMR0IF = 0;
TMR0_WriteTimer(lastTimerLoad);
}
...
if (isRunning) {
uint32_t timerVal = TMR0_ReadTimer();
...
timerStruct_t *prevPoint = (0);
timer->next = (0);

if(timerAbsoluteTime < absoluteTimeofLastTimeout)
{
timerAbsoluteTime += TMR0H - rebaseList() + 1;
...
if (period > TMR0H)
{
dummy.absoluteTime = absoluteTimeofLastTimeout + TMR0H;
dummy.next = listHead;
listHead = &dummy;
period = TMR0H;
}
...
void timeout_initialize(void)
{
TMR0_SetInterruptHandler(timeout_isr);
}
