...
# 1 "C:/Program Files (x86)/Microchip/MPLABX/v5.40/packs/Microchip/PIC18F-K_DFP/1.4.87/xc8\\pic\\include\\inline.h" 1 3
...
# 615 "C:\\Program Files\\Microchip\\xc8\\v2.30\\pic\\sources\\c99\\common\\doprnt.c"
...
# 692 "C:\\Program Files\\Microchip\\xc8\\v2.30\\pic\\sources\\c99\\common\\doprnt.c"
static int vfpfcnvrt(FILE *fp, char *fmt[], va_list ap)
{
    ...
    if ((*fmt)[0] == '%') {
        ...
        flags = width = 0;
        prec = -1;
# 779 "C:\\Program Files\\Microchip\\xc8\\v2.30\\pic\\sources\\c99\\common\\doprnt.c"
...
# 847 "C:\\Program Files\\Microchip\\xc8\\v2.30\\pic\\sources\\c99\\common\\doprnt.c"
        if ((*fmt[0] == 'd') || (*fmt[0] == 'i')) {
...
# 869 "C:\\Program Files\\Microchip\\xc8\\v2.30\\pic\\sources\\c99\\common\\doprnt.c"
        if (!strncmp(*fmt, "lld", ((sizeof("lld")/sizeof("lld"[0]))-1)) || !strncmp(*fmt, "lli", ((sizeof("lli")/sizeof("lli"[0]))-1))) {


            *fmt += ((sizeof("lld")/sizeof("lld"[0]))-1);
            ll = (*(long long *)__va_arg(*(long long **)ap, (long long)0));

            return dtoa(fp, ll);
        }
# 942 "C:\\Program Files\\Microchip\\xc8\\v2.30\\pic\\sources\\c99\\common\\doprnt.c"
        if (ct[0] == 'f') {
...
# 1204 "C:\\Program Files\\Microchip\\xc8\\v2.30\\pic\\sources\\c99\\common\\doprnt.c"
        if (*fmt[0] == 'u') {
...
# 1225 "C:\\Program Files\\Microchip\\xc8\\v2.30\\pic\\sources\\c99\\common\\doprnt.c"
        if (!strncmp(*fmt, "llu", ((sizeof("llu")/sizeof("llu"[0]))-1))) {

            *fmt += ((sizeof("llu")/sizeof("llu"[0]))-1);
            llu = (*(unsigned long long *)__va_arg(*(unsigned long long **)ap, (unsigned long long)0));
