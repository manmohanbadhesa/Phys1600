...
has_switch1_changed = poll_switch1_for_edges(PORTAbits.RA4);
...
switch(digit)
{
case 1: do { LATDbits.LATD0 = 1; } while(0);
...
do { LATDbits.LATD3 = 0; } while(0);
break;
case 3: do { LATDbits.LATD0 = 0; } while(0);
do { LATDbits.LATD1 = 0; } while(0);
do { LATDbits.LATD2 = 0; } while(0);
...
case 4: do { LATDbits.LATD0 = 0; } while(0);
do { LATDbits.LATD1 = 0; } while(0);
do { LATDbits.LATD2 = 0; } while(0);
do { LATDbits.LATD3 = 0; } while(0);
break;
