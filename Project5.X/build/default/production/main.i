...
# 248 "C:/Program Files (x86)/Microchip/MPLABX/v5.40/packs/Microchip/PIC18F-K_DFP/1.4.87/xc8\pic\include\proc\pic18f46k42.h"
...
password_attempt[counter]=i;




counter++;
if(counter == 5) password_attempt[counter]= '\0';
...
compare=strncmp(password_attempt,alarmset,5);
...
compare2=strncmp(password_attempt,alarmoff,5);
...
break;
case 1: do { LATDbits.LATD1 = 1; } while(0);
...
void buttonResponse(void)
{
has_switch_changed = poll_switch1_for_gate(PORTAbits.RA7);
...
has_switch1_changed = poll_switch1_for_edges(PORTCbits.RC4);
...
has_switch2_changed = poll_switch2_for_edges(PORTCbits.RC5);
...
has_switch3_changed = poll_switch3_for_edges(PORTCbits.RC6);
...
has_switch4_changed = poll_switch4_for_edges(PORTCbits.RC7);
...
has_switch1_changed = poll_switch5_for_edges(PORTCbits.RC4);
...
has_switch2_changed = poll_switch6_for_edges(PORTCbits.RC5);
...
has_switch3_changed = poll_switch7_for_edges(PORTCbits.RC6);
...
has_switch4_changed = poll_switch8_for_edges(PORTCbits.RC7);
...
has_switch1_changed = poll_switch9_for_edges(PORTCbits.RC4);
...
has_switch2_changed = poll_switch10_for_edges(PORTCbits.RC5);
...
has_switch3_changed = poll_switch11_for_edges(PORTCbits.RC6);
...
has_switch4_changed = poll_switch12_for_edges(PORTCbits.RC7);
