...
# 5 "geometric_shapes.c" 2


float volume_sphere(float radius)
{
    float volumes;
    volumes= 4*4*atanf(1)*powf(radius,3)/3;
    return volumes;
}
...
{
    float volumec;
    volumec=4*atanf(1)*height*powf(radius,2);
    return volumec;
}
