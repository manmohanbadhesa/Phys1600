...
{
    float Range;
    Range= 2*initialVelocity*sinf(angle*4*atanf(1)/180.0)*cosf(angle*4*atanf(1)/180.0)/9.81;
...
float MaxHeight(float initialVelocity, float angle)
{
        ...
        MaxHeight= powf(initialVelocity*sinf(angle*4*atanf(1)/180.0),2)/2.0/9.81;
...
float TimeinAir(float initialVelocity, float angle)
{
    ...
    TimeinAir= 2*initialVelocity*sinf(angle*4*atanf(1)/180.0)/9.81;
